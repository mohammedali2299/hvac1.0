    ...
    return (
        <Jumbotron className="mb-0">
            ...
            <Tabs defaultActiveKey="residential" className="border-0">
                <Tab eventKey="residential" title="Residential" className="bg-white border rounded shadow" >
                    <Row>
                ...
                <Tab eventKey="commercial" title="Commercial" className="bg-white border rounded shadow" >
                    <Row>
                        <Col xs={12} md={7} className="pt-2 ml-3">
