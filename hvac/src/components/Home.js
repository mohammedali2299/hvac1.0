                ...
                <Row>
                    <Col xs={12} lg={4} className="mt-3">
                        <Row>
                            ...
                            <Col lg={12}>
                                <Jumbotron className="d-flex flex-column align-items-center mb-0 emergency">
                                    <h2 className="text-white">Have an Emergency?</h2>
                                    <p className="text-white">Let United expedite your problem. Click below for more information.</p>
