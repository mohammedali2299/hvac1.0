...
function ContactLink(props) {
    return (
        <Jumbotron fluid className="border d-flex flex-column align-items-center mb-0 contactjumbo pt-3 pb-3 h-100">
            ...
            <p className="mb-3 text-center font-italic text-white pl-4 pr-4 pt-3 pb-3">Fill out our online form to be placed on the schedule right away, or contact us via e-mail or phone.</p>
