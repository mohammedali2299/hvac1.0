...
function ResComTemplate(props) {
    ...
    return(
        <Container fluid className="body gallery-background m-0 pl-0 pr-0">
            ...
            <Row noGutters fluid className="m-0" >
                ...
                <Col xs={{span: 8, offset: 2}} className="mt-3 mb-3 pl-5 pr-5 d-flex flex-column align-items-center">
                    ...
                    <Button href="/contact" className="cooling-secondary shadow-element btn-lg border-0 mt-4 mb-5 ml-5 ">Get Started</Button>
                </Col>
            </Row>
        </Container>
    );
