...
function ContactLink(props) {
    return (
        <Jumbotron fluid className="d-flex flex-column align-items-center mb-3 contactjumbo">
            <h2 className="mb-3 text-center text-white">Get Started with our Service Today!</h2>
            <p className="mb-3 text-white pl-4 pr-2">Fill out our online form to be placed on the schedule right away, or contact us via e-mail or phone.</p>
