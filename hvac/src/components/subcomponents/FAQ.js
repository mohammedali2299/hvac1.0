                ...
                <Row className="mt-5">
                    <Col xs={12} md={6}>
                        ...
                        <p className="mt-4 pl-5 pr-5 text-muted">This can depend on a variety of factors including the square footage and cubic footage of the structure 
                            as well how many floors you have. The ducting and infrastructure also play a large role in determining what works best. We offer professional recommendations on the best brands and sizes that will meet your specific needs.
                            We base our recommendations on factors such as installation costs, consumption of electricity, longevity, and the ability to maintain a consistent temperature throughout your building. 
                            Ask us for an hvac system recommendation or estimate via our <a href="/contact">contact form</a> to find out which system works best for you.
                        </p>
                    </Col>
                    <Col xs={12} md={6}>
                        <h4 className="pl-5 pr-5">How much will it cost to replace my furnace/AC?</h4>
                        <p className="mt-4 pl-5 pr-5 text-muted">Depending on the type and size of the HVAC system your home/building has, the price ranges between $4,000 and $25,000 on average. 
                ...
                <Row className="mt-4">
                    <Col xs={12} md={6}>
                        ...
                        <p className="mt-4 pl-5 pr-5 text-muted">Furnaces can last anywhere from 12-16 years. Some inidicators of a furnace that needs service include
                            abnormally high heating or electrical bills, loud noises coming from the unit, cold spots in your home/business, or if it's getting too old.
                ...
                <Row className="mt-4">
                    <Col xs={12} md={6}>
                        ...
                        <p className="mt-4 pl-5 pr-5 text-muted">An important part of preserving the quality of your system is to replace the filters on time. If you live alone
                            you need only replace it once every 6 months. The average "suburban home" should try to replace their filter every 3 months or 2 months if there are pets.
                    ...
                    <Col xs={12} md={6}>
                        ...
                        <p className="mt-4 pl-5 pr-5 text-muted">
                            ...
                            electricity and coolant to reduce the air temperature and send hot air out and keep cold air in. Ductwork is the means by which hot and cold air is transported 
