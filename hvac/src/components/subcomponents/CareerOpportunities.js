      ...
      <Row className="mt-4">
        <Col xs={{ span: 12, order: 2 }} lg={{ span: 6, order: 1 }}>
          <Jumbotron className="bg-white pt-0 pl-0 pr-0 shadow-element">
            <h5 className="w-100 title-yellow text-white m-0 pt-3 pb-3 pl-3">
              Employee info
            </h5>
                  ...
                  <Form.Group as={Row} controlId="description">
                    ...
                    <Col md={10}>
                      <Form.Control
                        as="textarea"
                        rows="5"
                        placeholder="Include any experience you've had with HVAC installations, repairs, and maintainence."
                      />
                    </Col>
                  </Form.Group>
        ...
        <Col fluid xs={{ span: 12, order: 1 }} lg={6}>
          <Jumbotron fluid className="shadow-element bg-white">
            <div className="pl-4 pr-4">
              ...
              <p className="pt-3">
                Become a part of our growing company. Just fill out our form and
                make sure to include any previous jobs or expereince you've had
                in the HVAC/Electrical field. Due to the wide variety of
                services we offer and our expereince in the business, we can
                provide many learning opportunities to help expand your
                skillset.
              </p>
            </div>
          </Jumbotron>
