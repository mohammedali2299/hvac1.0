        ...
        <Carousel activeIndex={index} direction={direction} onSelect={this.handleSelect} fade={true}>
          <Carousel.Item>
            ...
            <Carousel.Caption className="mb-5">
                ...
                <p className="mt-3 font-italic">"This is truly an all-inclusive HVAC and electrical solution provider. 
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption className="mb-5">
              <h3>Satisfied Customer</h3>
              <p className="mt-3 font-italic">"Imran was not only the first one to respond to my calls but was at my place immediately 
