    ...
    return(
        <Container fluid className="body m-0 pl-0 pr-0">
            <Row noGutters fluid className="m-0" >
                <Col xs={{ span: 12, order: 2}} lg={{ span: 12, order: 1 }} className="mt-3 mb-3 pl-5 pr-5">
                ...
                <Col xs={{ span: 12, order: 1}} lg={{ span: 12, order: 2 }} className="mt-0">
